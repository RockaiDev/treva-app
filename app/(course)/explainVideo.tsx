import { Alert, Dimensions, Linking, Modal, ScrollView, StyleSheet, Text, TouchableOpacity, View, Animated } from 'react-native'
    ...
    <>
      ...
      >
        ...
        <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', margin: 10, direction: 'rtl' }}>
          <Text style={[ConstantStyles.Title1, { fontSize: 26, textAlign: 'left' }]}>{ExplainVideo.title}</Text>
          ...
          <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', direction: 'rtl' }}>
            {ExplainVideo.attaches ? (
              ...
              >
                ...
                <Text style={[ConstantStyles.Title2, { fontSize: 18, marginRight: 10 }]}>{ExplainVideo.attaches.slice(0, 40)}</Text>
              </TouchableOpacity>
            ) : (
        ...
        >
          <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', alignItems: 'center', width: '100%', height: '100%', backgroundColor: 'rgba(0,0,0,0.5)', pointerEvents: hasLesson ? 'none' : 'auto' }}>
            ...
            <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: '100%', height: 270, backgroundColor: Colors.calmWhite, borderRadius: 10, padding: 20 }}>
              ...
              <Text style={[ConstantStyles.normalText, { fontSize: 18, marginBottom: 5, color: Colors.textColor, textAlign: 'center' }]}>قم بشراء المحاضرة لتتمكن من مشاهدة فيديو الشرح </Text>
        ...
        >
          <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%', backgroundColor: 'rgba(0,0,0,0.5)', pointerEvents: !CardBuyLesson ? 'none' : 'auto' }}>
            <LinearGradient
              ...
              style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', width: '100%', height: '100%', backgroundColor: Colors.calmWhite, borderRadius: 10, paddingVertical: 20 }}
            >
              <ScrollView
                ...
                <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
                  <View style={[ConstantStyles.shadowContainer, { display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-end', backgroundColor: Colors.calmWhite, borderRadius: 10, padding: 10, marginBottom: 20, width: 200, height: 60, direction: 'rtl', marginLeft: 10 }]}>
